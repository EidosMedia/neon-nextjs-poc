    ...
    for (let run = 0; run < RUNS; run++) {
      ...
      options = {
        ...
        url:
          ...
          "/core/publication/prepare?emauth=" +
          authToken,
        mode: "no-cors",
        data: body,
        headers: {
      ...
      for (const o of objs) {
        ...
        const content =
          '<?xml version="1.0" encoding="UTF-8"?><document><headgroup><headline><p>My title</p></headline></headgroup><summary><p>My summary</p></summary><byline><p>ale.ber</p></byline><content><p>Lorem ipsum</p></content></document>';
        ...
        response = await axios.post(
          process.env.NEON_BASE_HOST +
            "/core/publication/update?emauth=" +
            authToken +
            "&pubId=" +
            pubId,
          formData,
      ...
      options = {
        ...
        url:
          process.env.NEON_BASE_HOST +
          "/core/publication/publish?emauth=" +
          authToken +
          "&pubId=" +
          pubId,
        mode: "no-cors",
