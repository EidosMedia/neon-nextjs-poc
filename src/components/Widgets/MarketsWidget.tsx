...
export default function MarketsWidget({ neonData, gridContext }) {
    ...
    if (neonData) {
        ...
        const arrowDown = <Box sx={{ transform: 'rotate(180deg)', color: '#dc143c' }}>▲</Box>;
                    ...
                    render = (
                        <Container sx={{ my: 2, p: 2, backgroundColor: 'grey.300' }} maxWidth="lg">
                            ...
                            >
                                <Box sx={{ display: 'flex' }}>
                                    {arrowDown}
                                    <Typography sx={{ ml: 1, mr: 1, color: '#dc143c' }} variant="h6">
                                        0.25%
                                    </Typography>
                                ...
                                <Box sx={{ display: 'flex' }}>
                                    {arrowUp}
                                    <Typography sx={{ ml: 1, mr: 1, color: '#228b22' }} variant="h6">
                                        0.02%
                                    </Typography>
                                    <Typography sx={{ ml: 0, mr: 4 }} variant="h6">
                                        GBP/USD
