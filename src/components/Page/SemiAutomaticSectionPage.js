...
export default function SemiAutomaticSectionPage({ cobaltData, pageTitle, analyticsReport, semanticSearchData }) {
    //Swing quick open
    let uuid = null;
    ...
    let widgets = mainObjects.filter((o) => o.object.data.sys.baseType === 'widget')
    ...
    const render = (
        <Container maxWidth="lg">
            ...
            <Grid container spacing={2}>
                ...
                {(widgets ?
                    widgets.map((w) => <GenericWidget key="widget" cobaltData={w} semanticSearchData={semanticSearchData} />)
                    : null)}
            </Grid>
